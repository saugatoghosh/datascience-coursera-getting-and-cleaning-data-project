...
# Get the data and list of files
...
1. **Get the big picture of the structure of the data frame that will be used in the project**
...
3. **Explore properties of the above variables**
...
3. **Merge columns to get the dataframe for all data**
...
1. **Subset names of features by measurements on the mean and standard deviation**
...
```
3. **Check the structure of the dataframe 'Data'**
...
```
2. **Factorise variable "activity" in the dataframe "Data" using descriptive activity names and     check**
